...
async function loadFacts() {
  const res = await fetch(
    "https://edfrtttyfhxcbixntcox.supabase.co/rest/v1/facts",
    {
      headers: {
        apikey:
        ...
        authorization:
          "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImVkZnJ0dHR5Zmh4Y2JpeG50Y294Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3MTQ2NzM0MTAsImV4cCI6MjAzMDI0OTQxMH0.LQJ9hiyzzsQmFiRcGmTvXZtMQAH9ID3zQpzA3AWk3zc",
      },
    }
  );
